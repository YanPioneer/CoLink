...
# MODEL_PATH = os.path.join(father_path, 'models/training_20251112_202936', "Epoch8stage2_compressor_qwen25_15_model_16_5e-05_1e-05_tgt-1_qyembed_yid_512_512_1024_1.0_1.0_1.0_4.pth")  # LLM[-1]_qy[pad]_16_512_static_4_stage2_LLM+compressor_comp5e-5_llm1e-5 e8
# MODEL_PATH = os.path.join(father_path, 'models/training_20251114_002524', "Epoch9stage2_compressor_qwen25_15_model_16_5e-05_5e-06_tgt-1_qyembed_yid_512_512_1024_1.0_1.0_1.0_4.pth")  # LLM[-1]_qy[pad]_16_512_static_4_stage2_LLM+compressor_comp5e-5_llm5e-6 e9
# MODEL_PATH = os.path.join(father_path, 'models/training_20251115_203937', "Epoch6stage2_compressor_qwen25_15_model_16_1e-05_5e-06_tgt-1_qyembed_yid_512_512_1024_1.0_1.0_1.0_4.pth")  # LLM[-1]_qy[pad]_16_512_static_4_stage2_LLM+compressor_comp1e-5_llm5e-6 e6
# MODEL_PATH = os.path.join(father_path, 'models/training_20251116_164023', "Epoch7stage2_compressor_qwen25_15_model_16_1e-05_1e-05_tgt-1_qyembed_yid_512_512_1024_1.0_1.0_1.0_4.pth")  # LLM[-1]_qy[pad]_16_512_static_4_stage2_LLM+compressor_comp1e-5_llm1e-5 e7
# MODEL_PATH = os.path.join(father_path, 'models/training_20251116_203401', "Epoch6stage2_compressor_qwen25_15_model_16_5e-06_1e-05_tgt-1_qyembed_yid_512_512_1024_1.0_1.0_1.0_4.pth")  # LLM[-1]_qy[pad]_16_512_static_4_stage2_LLM+compressor_comp5e-6_llm1e-5 e6
# MODEL_PATH = os.path.join(father_path, 'models/training_20251117_154602', "Epoch5stage2_compressor_qwen25_15_model_16_1e-05_1e-05_tgt-1_qyembed_yid_512_512_1024_1.0_1.0_1.0_4.pth")  # LLM[-1]_qy[pad]_16_512_static_4_Epoch9_stage2_LLM+compressor_comp1e-5_llm1e-5 e5
...
LORA_ADAPTER_PATH = "../models/training_20251130_105914/Epoch4_qwen_lora_adapter"  # LLM[-1]_qy[pad]_16_512_static_8_lr0.00005_Epoch8_stage2_LLM+compressor_comp1e-5_llm1e-5 e4
...
def load_peft_models(device):
    ...
    # 加载checkpoint获取超参数
    checkpoint = torch.load(MODEL_PATH, map_location=device, weights_only=False)  # weights_only=False，放开torch的权重加载策略
...
def test_method_1_slots_plus_q(compressor, llm_model, tokenizer, example, 
    ...
    print(f"extract_history_features 和 compress_history_to_slots 总耗时: {elapsed_time:.4f} 秒")
...
def validate_compressor(compressor, compressor_name, llm_model, tokenizer, epoch_num, timestamp):
    ...
    prefix = "../val/LLM[-1]_qy[pad]_16_512_static_8_lr0.00005_Epoch8_stage2_LLM+compressor_comp1e-5_llm1e-5/"
...
def main():
    ...
    ###❗5. 保存详细结果
    prefix = "../LLM[-1]_qy[pad]_16_512_static_8_lr0.00005_Epoch8_stage2_LLM+compressor_comp1e-5_llm1e-5/"
    postfix = MODEL_PATH.split("compressor_")[-1].split(".pth")[0]
